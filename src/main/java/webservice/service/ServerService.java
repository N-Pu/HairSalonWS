 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/HairSalonWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/HairSalonWS?wsdl");
